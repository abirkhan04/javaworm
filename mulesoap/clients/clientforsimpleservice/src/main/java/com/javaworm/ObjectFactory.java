 ...
 * generated in the com.javaworm package. 
...
public class ObjectFactory {
    ...
    private final static QName _ShowPersonDetailResponse_QNAME = new QName("http://javaworm.com/", "showPersonDetailResponse");
    private final static QName _ShowPersonDetail_QNAME = new QName("http://javaworm.com/", "showPersonDetail");
    private final static QName _AddNumbers_QNAME = new QName("http://javaworm.com/", "addNumbers");
    private final static QName _AddNumbersResponse_QNAME = new QName("http://javaworm.com/", "addNumbersResponse");
    private final static QName _ShowPersonDetailArg1_QNAME = new QName("http://javaworm.com/", "arg1");
    private final static QName _ShowPersonDetailArg0_QNAME = new QName("http://javaworm.com/", "arg0");
    private final static QName _AddNumbersResponseReturn_QNAME = new QName("http://javaworm.com/", "return");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.javaworm
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "showPersonDetailResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "showPersonDetail")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "addNumbers")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "addNumbersResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "arg1", scope = ShowPersonDetail.class)
    public JAXBElement<Integer> createShowPersonDetailArg1(Integer value) {
        return new JAXBElement<Integer>(_ShowPersonDetailArg1_QNAME, Integer.class, ShowPersonDetail.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "arg0", scope = ShowPersonDetail.class)
    public JAXBElement<String> createShowPersonDetailArg0(String value) {
        return new JAXBElement<String>(_ShowPersonDetailArg0_QNAME, String.class, ShowPersonDetail.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "return", scope = AddNumbersResponse.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "return", scope = ShowPersonDetailResponse.class)
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "arg1", scope = AddNumbers.class)
    public JAXBElement<Integer> createAddNumbersArg1(Integer value) {
        return new JAXBElement<Integer>(_ShowPersonDetailArg1_QNAME, Integer.class, AddNumbers.class, value);
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://javaworm.com/", name = "arg0", scope = AddNumbers.class)
    public JAXBElement<Integer> createAddNumbersArg0(Integer value) {
        return new JAXBElement<Integer>(_ShowPersonDetailArg0_QNAME, Integer.class, AddNumbers.class, value);
    }
